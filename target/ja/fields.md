...
* [アセット](assets.md)は、「設定 > アセット > [アセットソース名] > フィールドレイアウト」のアセットソースごとに定義されたフィールドレイアウトを使用します。
...
入力タイプのフィールドレイアウトは、異なる特徴があります。それらはフィールドを含むコンテンツタブを定義できます。必要数のコンテンツタブを作成し、類似するフィールドをまとめて分類するために利用します。各コンテンツタブには歯車アイコンが表示され、リネームや削除ができます。
