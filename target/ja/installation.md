...
2つ目のステップは、データベース接続情報の入力です。Step 3 で保存した情報を入力してください。
...
最後のステップは、システム名、ベース URL、および言語の設定です。Craft は他の設定に基づいて3つの項目をあらかじめ埋めますが、「Finish up（完了）」ボタンをクリックする前にそれぞれのフィールドを編集することができます。
